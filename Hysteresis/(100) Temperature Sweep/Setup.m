...
a_film = BTO_pct * 4.006 + STO_pct * 3.905;

Us_11 = ( a_11_sub - a_film ) / a_film; % unitless misfit strain
Us_22 = ( a_22_sub - a_film ) / a_film; % anisotropic misfit strain
Us_12 = 0;

STRING = 'BST 82 SSO'; % Material Name
...
%% Grid Size
Nx = 128; Ny = Nx; Nz = 36; % Grid Points
