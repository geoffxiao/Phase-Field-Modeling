...
for E_1_applied_FilmRef = E_fields
    
    folder = sprintf('%gkV-cm',E_1_applied_FilmRef/1e5);
    mkdir(folder);
    cd(folder);
    ...
    E_vectors = [E_vectors, E_1_applied_FilmRef];
    
    final = sprintf('./final_%g_%gC_%gkV-cm.mat',Us*1e2,T,E_1_applied_FilmRef/1e5);
...
for E_1_applied_FilmRef = E_fields
    ...
    folder = sprintf('%g_2kV-cm',E_1_applied_FilmRef/1e5);
    mkdir(folder);
    cd(folder);
    movefile('../init.mat','./init.mat');
