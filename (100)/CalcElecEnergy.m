if( ELECTRIC )
    ...
    f1_elec = -0.5 * E_1_depol .* in_film .* Nucleation_Sites; 
    f2_elec = -0.5 * E_2_depol .* in_film .* Nucleation_Sites; 
    f3_elec = -0.5 * E_3_depol .* in_film .* Nucleation_Sites; 
    ...
    E_1_depol = 0; E_2_depol = 0; E_3_depol = 0;     
    potential = 0;
