...
if( NUCLEATE )
    ...
    z_edges = 2;
    for i = 1 : 7
        Nucleation_Sites(randi([xy_edges,Nx-Nucleation_Size+1-xy_edges])+(0:Nucleation_Size-1),randi([xy_edges,Ny-Nucleation_Size+1-xy_edges])+(0:Nucleation_Size-1),randi([z_edges,Nz-Nucleation_Size+1-z_edges])+(0:Nucleation_Size-1)) = 0;
    end
