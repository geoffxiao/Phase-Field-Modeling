...
TotalStrain_homo_11 = @(P1, P2, P3) Us_11;
TotalStrain_homo_22 = @(P1, P2, P3) Us_22;
TotalStrain_homo_12 = @(P1, P2, P3) Us_12;
TotalStrain_homo_33 = @(P1, P2, P3) -( C12 * TotalStrain_homo_11(P1,P2,P3) + C12 * TotalStrain_homo_22(P1,P2,P3) ) / C44;
TotalStrain_homo_23 = @(P1, P2, P3) 0;
TotalStrain_homo_13 = @(P1, P2, P3) 0;
