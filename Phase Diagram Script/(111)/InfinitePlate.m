...
% 3D fft diff..
bc_film_1_3Dk = (Eigenstrain_FilmRef_13_k - kx_grid_3D.*u_3_A_k.*1i).*(C11/3 - C12/3 + C44/3) + (Eigenstrain_FilmRef_13_k - kz_grid_3D.*u_1_A_k.*1i).*(C11/3 - C12/3 + C44/3) - (Eigenstrain_FilmRef_12_k - kx_grid_3D.*u_2_A_k.*1i).*((2.^(1/2).*C12)/6 - (2.^(1/2).*C11)/6 + (2.^(1/2).*C44)/3) - (Eigenstrain_FilmRef_12_k - ky_grid_3D.*u_1_A_k.*1i).*((2.^(1/2).*C12)/6 - (2.^(1/2).*C11)/6 + (2.^(1/2).*C44)/3);
bc_film_2_3Dk = (Eigenstrain_FilmRef_23_k - ky_grid_3D.*u_3_A_k.*1i).*(C11/3 - C12/3 + C44/3) + (Eigenstrain_FilmRef_23_k - kz_grid_3D.*u_2_A_k.*1i).*(C11/3 - C12/3 + C44/3) - (Eigenstrain_FilmRef_11_k - kx_grid_3D.*u_1_A_k.*1i).*((2.^(1/2).*C12)/6 - (2.^(1/2).*C11)/6 + (2.^(1/2).*C44)/3) + (Eigenstrain_FilmRef_22_k - ky_grid_3D.*u_2_A_k.*1i).*((2.^(1/2).*C12)/6 - (2.^(1/2).*C11)/6 + (2.^(1/2).*C44)/3);
bc_film_3_3Dk = (Eigenstrain_FilmRef_11_k - kx_grid_3D.*u_1_A_k.*1i).*(C11/3 + (2.*C12)/3 - (2.*C44)/3) + (Eigenstrain_FilmRef_22_k - ky_grid_3D.*u_2_A_k.*1i).*(C11/3 + (2.*C12)/3 - (2.*C44)/3) + (Eigenstrain_FilmRef_33_k - kz_grid_3D.*u_3_A_k.*1i).*(C11/3 + (2.*C12)/3 + (4.*C44)/3);
